          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center md:text-left">
            <div>
              ...
              <ul className="space-y-2 text-xs text-white/40">
                ...
                <li><Link href="/diagnostics" className="hover:text-cyan-400 transition-colors">Diagnostics</Link></li>
                <li><Link href="/history" className="hover:text-cyan-400 transition-colors">Service History</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-xs text-white/40">
                ...
                <li><a href="https://lotopspro.com" target="_blank" rel="noopener noreferrer" className="hover:text-cyan-400 transition-colors">LotOpsPro</a></li>
              </ul>
            </div>
            <div>
