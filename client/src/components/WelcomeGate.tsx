...
2. PLATFORM SERVICES
GarageBot provides:
• Parts Aggregation: Search across 104 automotive and motorized vehicle retailers. We are an aggregator and do not sell parts directly.
                ...
                {view === "signup" && (
                  <>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Search 104 retailers, save vehicles, get AI recommendations
                    </p>
                  </>
                )}
                {view === "signup-terms" && (
