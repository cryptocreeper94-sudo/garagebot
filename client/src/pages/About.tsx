              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="space-y-3 text-muted-foreground">
                    <p>GarageBot aggregates <strong className="text-foreground">96 retailers</strong> into a single, powerful search platform with real-time price comparison. We cover <strong className="text-foreground">ALL motorized vehicles</strong>:</p>
