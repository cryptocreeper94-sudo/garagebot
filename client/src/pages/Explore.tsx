...
const FEATURE_CATEGORIES: FeatureCategory[] = [
  {
    ...
    description: "Search, compare, and save across 95 retailers",
    icon: ShoppingCart,
    gradient: "from-cyan-500 to-blue-600",
    features: [
      { name: "Parts Search", description: "Search 15M+ parts across 95 retailers with price comparison and vehicle-aware results.", href: "/home", icon: Search, image: imgPartsSearch, glowColor: "cyan", featured: true, subFeatures: ["94 Retailers", "Price Compare", "Local Pickup", "Vehicle-Aware"] },
      ...
      { name: "Price Alerts", description: "Set alerts on parts you need. Get notified when prices drop at any of the 95 retailers.", href: "/garage", icon: TrendingDown, image: imgPriceAlerts, glowColor: "yellow", subFeatures: ["Price Drops", "Multi-Retailer", "Target Price", "History"] },
    ],
  },
  {
    title: "My Garage",
              ...
              <div className="relative z-10 flex flex-col sm:flex-row items-center gap-4">
                ...
                <div className="flex-1 text-center sm:text-left">
                  ...
                  <p className="text-xs text-white/50">
                    Search 95 retailers, save vehicles, get AI recommendations — all free
                  </p>
                </div>
