          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
            <Card className="bento-glass bento-glow border-primary/30 p-3 h-full">
              ...
              <p className="text-xs text-muted-foreground mb-3">
                Tell Buddy what you need - he'll find the right part across 96 retailers.
              </p>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Join 96 retailers. Get featured, earn badges, compete for Vendor of the Month!
                    </p>
                  </div>
      ...
      <section className="py-12 px-4" data-testid="section-how-it-works">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { step: 1, icon: Search, title: "Search Once", desc: "Enter your part name, number, or vehicle info. GarageBot searches 96 retailers simultaneously.", color: "from-cyan-500/20 to-cyan-600/10", iconColor: "text-cyan-400", borderColor: "border-cyan-500/30" },
