      ...
      <div className="max-w-2xl mx-auto px-4 pt-24 pb-12 flex-1">
        ...
        >
          ...
          <Card className="glass-ultra border-primary/20 p-6">
            <p className="text-muted-foreground mb-6">
              Join our network of 97 retailers and reach millions of customers searching for auto parts. Fill out the form below and our partnerships team will be in touch.
            </p>
