  ...
  app.post("/api/marketing/seed", isAuthenticated, async (req: any, res) => {
    try {
      const marketingContent = [
        { content: "Did you know the average car owner overpays $47 per brake job by not comparing prices? GarageBot searches 94 retailers instantly so you never overpay again.", platform: "all", hashtags: ["GarageBot", "AutoParts", "SaveMoney", "BrakeParts", "SmartShopping"], targetSite: "garagebot", category: "cars", contentType: "educational", tone: "professional", cta: "shop-now" },
        { content: "Weekend project alert! Changing your own oil saves $30-$60 every time. Search GarageBot for the best oil filter prices across 94 stores. Your wallet will thank you.", platform: "all", hashtags: ["DIY", "OilChange", "WeekendWarrior", "GarageBot", "AutoRepair"], targetSite: "garagebot", category: "diy", contentType: "evergreen", tone: "friendly", cta: "shop-now" },
        ...
        { content: "Right Part. First Time. Every Engine. From your daily driver to your RC car collection — GarageBot searches 94 retailers so you always find the best price.", platform: "all", hashtags: ["GarageBot", "RightPartFirstTime", "AutoParts", "EveryEngine", "PriceComparison"], targetSite: "garagebot", category: "brand", contentType: "evergreen", tone: "professional", cta: "visit-site" },
        ...
        { content: "Don't let a dead battery ruin your morning. Most car batteries last 3-5 years. Check your battery age and compare replacements from 94 retailers on GarageBot.", platform: "all", hashtags: ["CarBattery", "DeadBattery", "GarageBot", "AutoParts", "BeReady"], targetSite: "garagebot", category: "cars", contentType: "evergreen", tone: "friendly", cta: "shop-now" },
        ...
        { content: "Motorcycle riders: Your chain and sprocket kit should be replaced as a set — never mix old and new. Find complete kits from $45 across 94 retailers on GarageBot.", platform: "all", hashtags: ["Motorcycle", "ChainAndSprocket", "BikerMaintenance", "GarageBot", "TwoWheels"], targetSite: "garagebot", category: "motorcycle", contentType: "educational", tone: "professional", cta: "shop-now" },
    ...
    try {
      ...
      const completion = await openai.chat.completions.create({
        ...
        messages: [
          {
            role: "system",
            content: `You are a marketing expert for GarageBot, an auto parts aggregator that searches 94 retailers. Generate engaging social media posts that:
