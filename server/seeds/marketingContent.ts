...
const marketingContent = [
  ...
  { content: "Boat season is almost here! Marine parts can cost 40% more at specialty shops vs online retailers. GarageBot compares prices from West Marine, Bass Pro, and 50+ more stores. Get ready now!", platform: "all", hashtags: ["BoatLife", "MarineParts", "GarageBot", "BoatSeason", "Boating"], targetSite: "garagebot", category: "marine", contentType: "seasonal", tone: "promotional", cta: "shop-now", season: "spring" },
